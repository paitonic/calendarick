...
// TODO: Can it be replaced with WEEKDAYS.SUNDAY, WEEKDAYS.MONDAY ... ?
...
// TODO: Add tests
export function isDeepSameValue(value1, value2) {
  if ((typeof value1) !== (typeof value2)) {
    return false;
  } else if (Array.isArray(value1) && value1.length !== value2.length) {
    return false;
  }
  ...
  if (value1 instanceof Date) {
    ...
    return value1.reduce((isEqual, date, index) => {
      return isEqual && isDeepSameValue(date, value2[index]);
    }, true);
  }

  throw Error("isDeepSameValue: value is not a Date and not an Array")
}
